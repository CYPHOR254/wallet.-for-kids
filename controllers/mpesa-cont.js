...
//           req.access_token = result.access_token;
//           next();
//           return result.access_token; // add return statement here
  ...
  request(
    {
      ...
      json: {
        ...
        SecurityCredential:"MTc0Mzc5YmZiMjc5ZjlhYTliZGJjZjE1OGU5N2RkNzFhNDY3Y2QyZTBjODkzMDU5YjEwZjc4ZTZiNzJhZGExZWQyYzkxOTIwMjMwNDE3MTIxMjI2",
